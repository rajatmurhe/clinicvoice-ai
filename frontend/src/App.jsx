...
function PillIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="3.5" y="9.5" width="17" height="7" rx="3.5" transform="rotate(-45 12 13)" stroke="currentColor" strokeWidth="1.7"/>
      <path d="M9.5 9.5L14.5 14.5" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/>
    </svg>
  );
}
...
function NoteIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M6 3h9l5 5v13a1 1 0 01-1 1H6a1 1 0 01-1-1V4a1 1 0 011-1z" stroke="currentColor" strokeWidth="1.7" strokeLinejoin="round"/>
...
const CAPABILITIES = [
  ...
  { icon: NoteIcon, label: 'Report a symptom or concern', example: '"I have an ongoing symptom"' },
...
function App() {
  ...
  const orbState = isRecording ? 'listening' : loading ? 'thinking' : '';
  const orbHint = isRecording ? 'Listening...' : loading ? 'Thinking...' : 'Tap to speak';
        ...
        <div className="chat-column">
          <div className="voice-stage">
            <div className={'orb-wrap ' + orbState}>
              ...
              <button
                className={'orb-btn ' + (isRecording ? 'recording' : loading ? 'thinking' : '')}
